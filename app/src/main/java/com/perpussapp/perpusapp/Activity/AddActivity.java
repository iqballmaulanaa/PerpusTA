...
public class AddActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userLevel = Constant.getLevel(this); // Ambil level login
        ...
        if (userLevel == 2) {
            mySpinner.setVisibility(View.GONE); // siswa tidak pilih nama
            pinjamModel.setNis(Constant.getUserId(this)); // ambil NIS siswa dari sesi
        } else {
            // admin bisa pilih nama siswa
    ...
    public void addList() {
        ...
        mySpinner.setOnItemClickListener(position -> listBukuModel.setBukuKey(constant.getBukuKey(position)));
    ...
    public void simpanPinjam(View view) {
        ...
        if (userLevel != 2 && pinjamModel.getNis() == null) {
        ...
        if (getIntent().hasExtra("isEdit")) {
            mDatabase.child("listPinjam").child(getIntent().getStringExtra("pinjamKey"))
                    ...
                    .addOnSuccessListener(aVoid -> mDatabase.child("listBookPinjam")
